...
// resme tıklayınca aç
document.querySelectorAll(".project-details-img img").forEach(img => {
...
closeBtn.addEventListener("click", function (e) {
    e.preventDefault();
    e.stopPropagation(); // önemli!
    modal.style.display = "none";
});

// dışarı tıklayınca kapat
modal.addEventListener("click", function (e) {
    e.preventDefault();        // scroll'u engeller
    e.stopPropagation();       // event yukarı gitmez
